...
self.addEventListener('fetch', (e) => {
  ...
  // 6. Local icons, images, manifest → cache-first
  if (url.origin === self.location.origin &&
...
<meta name="theme-color" content="#C9A84C"><title>Prakasha — Offline</title>
<style>
...
.d{width:90px;height:1px;background:linear-gradient(90deg,transparent,#C9A84C,transparent);
   margin:0 auto 20px}
...
<ol>
  ...
  <li>Let it fully load &amp; browse a few tabs</li>
  <li>Works completely offline from then on ✦</li>
</ol>
